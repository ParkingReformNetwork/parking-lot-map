...
test.describe("createChoice()", () => {
  test("city and state", () => {
    expect(
      createChoice({ id: parseCityId("tempe-az"), name: "Tempe, AZ" }),
    ).toEqual({
      value: "tempe-az",
      label: "Tempe, AZ",
  ...
  test("city and descriptor", () => {
    expect(
      createChoice({
        id: parseCityId("tempe-rail-station"),
        name: "Tempe - rail station",
      }),
    ).toEqual({
  ...
  test("only city", () => {
    expect(createChoice({ id: parseCityId("tempe"), name: "Tempe" })).toEqual({
      value: "tempe",
      label: "Tempe",
...
test.describe("convertToChoicesJs()", () => {
  const city1 = { id: parseCityId("city1"), name: "City 1" };
  const city2 = { id: parseCityId("city2"), name: "City 2" };
  const city3 = { id: parseCityId("city2"), name: "City 3" };
